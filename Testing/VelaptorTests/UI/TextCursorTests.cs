...
public class TextCursorTests
{
    ...
    private readonly Mock<IDisposable> textBoxStateUnsubscriber;
    ...
    {
        this.textBoxStateUnsubscriber = new Mock<IDisposable>();
        ...
        this.textBoxStateReactable.Setup(m =>
            ...
            .Returns(() => this.textBoxStateUnsubscriber.Object);
    }
    ...
    #region Method Tests
    // TODO: Create test for TextBoxEvent.None
