...
internal class TextCursor : ITextCursor
{
    ...
    private void HandleTextBoxResizing()
    {
        ...
        var preTextViewHeight = this.preMutateState.TextView.Height;
        ...
        var heightHasGrown = postTextViewHeight > preTextViewHeight;

        if (textWidthSmallerThanView)
        {
            var horizontalDisplacement = Math.Abs(preTextViewWidth - postTextViewWidth).Half();
            var verticalDisplacement = Math.Abs(preTextViewHeight - postTextViewHeight).Half();
            ...
            // {
            //     // Move cursor to the left
            //     this.cursor.Position = this.cursor.Position with { Y = this.cursor.Position.Y - horizontalDisplacement };
            // }
            // else
            // {
            //     // Move cursor to the right
