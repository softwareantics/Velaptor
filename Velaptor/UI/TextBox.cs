...
public sealed class TextBox : ControlBase
{
    ...
    private void UpdateTextPos()
    {
        ...
        this.textPos = this.textPos with { X = charBoundsCenterX };//, Y = Position.Y };
    }
    ...
    private void BackspaceSingleChar()
    {
        ...
        {
            this.text.RemoveChar(this.currentCharIndex - 1);
        }
    ...
    private void DeleteCurrentChar()
    {
        ...
        this.text.RemoveChar(this.currentCharIndex);
        this.textSize = this.font.Measure(this.text.ToString());
    ...
    private void CalcYPositions(float prevHeight, float currentHeight)
    {
        ...
        AdjustPosForCenter(prevHeight, currentHeight);
    ...
    private void AdjustPosForCenter(float prevHeight, float currentHeight) =>
